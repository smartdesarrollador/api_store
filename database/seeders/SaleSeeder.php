        ...
        Sale::factory()->count(1000)->create()->each(function($p) {
            ...
            for ($i=0; $i < $num_items; $i++) { 
                ...
                $sale_detail = SaleDetail::create([
                    ...
                    "discount" => $discount_cupone ? $discount_cupone->discount : 0,
                    "type_campaing" => $is_cupon_discount == 2 && $discount_cupone ? $discount_cupone->type_campaing : NULL,
                    "code_cupon" => $is_cupon_discount == 1 && $discount_cupone ? $discount_cupone->code : NULL,
                    "code_discount" => $is_cupon_discount == 2 && $discount_cupone ? $discount_cupone->code : NULL,
